...
SECRET_KEY = 'django-insecure-hcrwsl5l-r#=s6514n7i6&!kqx#@1cn8a1dz8!v@edntz7kv(!'
...
INSTALLED_APPS = [
    ...
    'django_extensions',  # Para generar diagramas
    'myapp',  # App principal
]
...
MIDDLEWARE = [
    ...
    'myapp.middleware.AuditMiddleware',  # Middleware de auditoría personalizado
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'myapp.context_processors.base_context',
            ],
        },
    },
]
...
LOGGING = {
    ...
    'loggers': {
        'django': {
            'handlers': ['file_general', 'file_error', 'console'],
            'level': 'INFO',
            'propagate': False,
        },
        'django.security': {
